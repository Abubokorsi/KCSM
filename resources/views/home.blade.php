        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Welcome to <span class="text-primary">Kazi Communications</span></h1>
    ...
    <div class="container-xxl py-5 destination">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <a href="/destination" class="mb-4 d-inline-block">See All</a>
            </div>
            <div class="row g-3">
                @foreach($destinations as $key=>$destination)
                @if(4>$key)
                <div class="col-lg-4 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                    <a class="position-relative d-block overflow-hidden" href="/destination">
                        <img class="img-fluid" src="{{asset('uploads/destination/'.$destination->image)}}" alt="" style="height: 400px; width:100%;">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <a href="/package" class="mb-4 d-inline-block">See All</a>
            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('uploads/package/'.$package->image)}}" alt="" style="height: 300px;">
                        </div>
            ...
            <div class="booking p-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit.</p>
                        <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                        <a class="btn btn-outline-light py-3 px-5 mt-2" href="/booking">Read More</a>
                    </div>
                    <div class="col-md-6">
                        <h1 class="text-white mb-4">Book A Tour</h1>
                        <form action="{{route('booking.stores')}}" method="POST">
                            @csrf
                            <div class="row g-3"> 
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating ">
                                        <input type="time" class="form-control bg-transparent " name="time">
                                        <label>Time</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control bg-transparent" name="person" placeholder="Person">
                                        <label>person</label>  
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-transparent" placeholder="Special Request" name="message" style="height:60px"></textarea>
                                        <label>Message</label>
                                    </div>
                                </div>
                                <div class="col-12">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <a href="/team" class="mb-4 d-inline-block">See All</a>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('uploads/guide/'.$guide->image)}}" alt="">
                        </div>
