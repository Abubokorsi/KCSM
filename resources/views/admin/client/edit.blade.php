        ...
        <div class="card card-primary">
              ...
              <form action="{{route('client.update',$client->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label >details</label>
                    <input type="text" class="form-control" name="details" value="{{$client->details}}">
                  </div> 
                  <div class="form-group">
                    <label for="clientImage">image</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="image" class="custom-file-input" id="clientImage">
                    ...
                    <img src="{{asset('uploads/client/'.$client->image)}}" alt="" style="height: 80px; width:120px;">
                  </div>
                </div>
                <!-- /.card-body -->
